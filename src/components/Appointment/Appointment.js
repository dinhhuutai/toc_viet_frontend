    ...
    return (
        <div className="bg-[#333333] text-[#fff] py-[14px] px-[24px] rounded-[10px]">
            <div className="flex items-center">
                ...
                <div onClick={() => dispatch(modalBookSlice.actions.openModalBook())} className="ml-[20px] lg:ml-[40px] text-[#000] px-[6px] lg:px-[14px] py-[8px] linearMain rounded-[4px] cursor-pointer">
            ...
            <div className="mt-[10px]">
                <p className="flex items-center">
                    Gọi{' '}
                    <a href="tel:0985045419" className="text-[#8b8bed] underline flex items-center mx-[8px]">
                        <div className="text-[10px] mr-[2px]"><BsFillTelephoneFill /></div>
