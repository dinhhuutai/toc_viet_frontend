...
function Train() {
    ...
    const getData = async () => {
        try {
            ...
            const res1 = await axios.get(`${process.env.REACT_APP_API_URL}/v1/bannerTrain/getAll`);

            if (res1.data.success) {
                setBannerImage(res1.data.bannerTrain[0]);
            }
        } catch (error) {}
    };
            ...
            <div className="pb-[50px]">
                <div>
                    <img
                        ...
                        className="w-[100%] lg:h-[300px] h-[200px] object-fill"
                    />
                </div>
