...
function Table({
    ...
    useEffect(() => {
        ...
        if(newArray.length === services?.length && services?.length !== 0) {
        ...
        <div className="mt-[20px] overflow-auto scrollbar-admin-sidebar">
            <table className="w-full flex flex-col justify-center">
                ...
                <tbody className="w-full">
                        ...
                        return (
                            ...
                            >
                                <td className="w-[30px] shrink-0 border-r-solid border-r-[1px] border-r-[#c4b8b8] flex justify-center items-center">
                                    <input checked={listCheck.includes(index)} onChange={(e) => handleCheckItem(index, e)} data-id={listCheck.includes(index) ? service._id : null} name="inputCheckboxArtistList" type="checkbox" />
                                </td>
                                ...
                                <td className='w-[200px] flex-1 shrink-0'>
                                    <Link to={`${config.routes.adminServiceUpdate}/${service._id}`} className="w-full h-full cursor-pointer border-r-solid border-r-[1px] border-r-[#c4b8b8] flex items-center px-[10px] py-[4px]">
                                        {service.name}
                                    </Link>
                                </td>
                    ...
                    <div className='flex mt-[20px] justify-center w-full font-[600] text-[13px] uppercase text-[#ae9c9c]'>Không có dịch vụ này trong danh sách</div>
                }
                </tbody>
            </table>
        </div>
