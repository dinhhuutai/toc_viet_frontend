                        ...
                        return (
                            ...
                            >
                                ...
                                <td className='w-[200px] flex-1 shrink-0'>
                                    <Link to={`${config.routes.adminProductUpdate}/${service._id}`} className="w-full h-full cursor-pointer border-r-solid border-r-[1px] border-r-[#c4b8b8] flex items-center px-[10px] py-[4px]">
                                        {service.name}
                                    </Link>
                                </td>
